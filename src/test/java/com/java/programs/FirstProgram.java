...
public class FirstProgram {
	...
	public static void main(String[] args) {
		...
		// 1 0 =0
		// 0 0 =0
		System.out.println(obj.y < obj.x && obj.x < obj.y);// &&The logical && operator doesn't
											// check second condition if first
											// condition is false. It checks
											// second condition only if first
											// one is true
		//The bitwise & operator always checks both conditions whether first condition is true or false.
		System.out.println(obj.y < obj.x & obj.x < obj.y);
		//The logical || operator doesn't check second condition if first condition is true. It checks second condition only if first one is false.
		System.out.println(a < b || obj.y > obj.x);
		//The bitwise | operator always checks both conditions whether first condition is true or false.
		System.out.println(a < b | obj.y > obj.x);
		System.out.println("C value : " + c);
		System.out.println("V: " + v);
		System.out.println(a - b);
		System.out.println(obj.y / obj.x);//Quotient
		System.out.println(obj.y % obj.x);//remainder
